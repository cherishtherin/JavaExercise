...
public class HWK4_02 {
    ...
    static void attack(Monster a, Monster b) {
       ...
       if(b.defense>a.attack){
           diff=b.defense-a.attack*0.025;
           a.attack=a.attack-a.attack*(int)(diff*a.attack);
       }
       else if(a.attack>b.defense){
           diff=(a.attack-b.defense)*0.05;
           a.attack=a.attack+(int)(a.attack*diff);
       }
